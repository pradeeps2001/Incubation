...
<body>
				...
				<div class="right-menu">
					<div>
						<button id="menuicon" class="btn btn-dark btn-sm" type="button"
							...
							<img id="manicon" alt="menu" src="<%=request.getContextPath()%>/jsp/images/user2.png">
						</button>
					</div>
					<div class="dropdown-menu">
						<form action="<%=request.getContextPath()%>/myServlet"
							...
							<div class="text-centre mt-1">
								<button class="btn btn-dark btn-sm" id="menubtn" type="submit" value="Edit Customer Details" name="data">
	...
	<div align="left">
		<iframe name="menu" id="menuframe" src="jsp/CustomerMenu.jsp">
		</iframe>
	</div>
	<div align="right">
		<iframe name="content" class=""
			id="content" src="jsp/CustomerInitialContent.jsp"> </iframe>
	</div>
	<footer id="footer">
	<div class="social-links">
			<ul>
				...
				<li class="social-items"><a href="#"><ion-icon name="logo-linkedin"></ion-icon></a></li>
