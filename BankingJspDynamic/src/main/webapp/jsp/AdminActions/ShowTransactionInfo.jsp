		...
		<section>
			...
			<form action="<%=request.getContextPath()%>/myServlet" method="post">
				<div class="form-inline">
					<input type="number" name="customerId" id="group-1" placeholder="Customer ID" required>
					<select name="time" id="group-2" required>
						...
						<button class="btn btn-outline-primary btn-sm" type="submit" id="shwTransBtn"
							value="Show Statement" name="data">Show</button>
				</div>
				</form>
				<br>
