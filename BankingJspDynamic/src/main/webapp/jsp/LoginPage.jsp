						...
						<div class="mt-2 ms-2 float-start">User Login</div>
							<form class="needs-validation"
								...
								<div id="userId" class="form-group was-validated">
									<input type="number" class="form-control mt-5 my-3 py-2" id="user"
										name="user" placeholder="Enter your User ID" required>
								</div>
								...
								<div class="text-centre mt-3">
									<button id="loginbtn" class="btn btn-primary" type="submit" value="Login"
